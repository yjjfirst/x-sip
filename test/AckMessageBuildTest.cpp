...
{
    MESSAGE *ack = BuildAckMessageWithinClientTransaction(inviteMessage, proxy, port,(char *) "");
...
{
    MESSAGE *ack = BuildAckMessageWithinClientTransaction(inviteMessage, proxy, port, (char *)"123456");    
