...
TEST(UserAgentTestGroup, BindingTest)
{
    ...
    BuildTestingMessage();
    struct Transaction *t = AddClientTransaction(message, (struct TransactionUserNofifiers *)dialog);
...
TEST(UserAgentTestGroup, RemoveBindingTest)
{
    ...
    mock().expectOneCall("SendOutMessageMock");
    message = BuildBindingMessage(dialog);
    t = AddClientTransaction(message, (struct TransactionUserNofifiers *)dialog);
...
TEST(UserAgentTestGroup, InviteSucceedTest)
{
    ...
    AddClientTransaction(message, (struct TransactionUserNofifiers *)dialog);
